...
const form = useForm({
  ...
  birth: props.teacher?.birth || '',
  contact: props.teacher?.contact || '',
  id_card: props.teacher?.id_card || '',
})
  ...
  <div class="px-3 py-4" >
    <div class="card shadow border-0 mx-auto" style="max-width: 720px;">
      <div class="card-header bg-primary text-white text-center">
        ...
        <h2 class="mb-0" style="font-family: Georgia, 'Times New Roman', Times, serif;">Tanár profil szerkesztése</h2>
      </div>
